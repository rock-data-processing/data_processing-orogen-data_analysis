...
#ifndef DATA_ANALYSIS_DERIVATIVESGTASK_TASK_HPP
#define DATA_ANALYSIS_DERIVATIVESGTASK_TASK_HPP
...
namespace data_analysis{
     ...
     * Compute the first derivative of the input stream using a Savitzki Golay (SG) filter
     * \details
     * The name of a TaskContext is primarily defined via:
     \verbatim
     deployment 'deployment_name'
         task('custom_task_name','data_analysis::DerivativeSGTask')
     end
     \endverbatim
     *  It can be dynamically adapted when the deployment is called with a prefix argument.
     */
    class DerivativeSGTask : public DerivativeSGTaskBase
    {
    ...
    public:
         ...
         */
        DerivativeSGTask(std::string const& name = "data_analysis::DerivativeSGTask");
         ...
         * 
         */
        DerivativeSGTask(std::string const& name, RTT::ExecutionEngine* engine);

        /** Default deconstructor of DerivativeSGTask
         */
        ~DerivativeSGTask();
